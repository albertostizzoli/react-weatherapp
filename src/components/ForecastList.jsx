            ...
            <table className="min-w-full bg-white rounded-lg shadow-md overflow-hidden">
                <thead>
                    <tr className="text-white bg-gradient-to-r from-blue-500 to-blue-700">
                        <th className="px-6 py-5 text-center font-semibold">Giorno</th>
                        <th className="px-6 py-5 text-center font-semibold">Temperatura</th>
                        <th className="px-6 py-5 text-center font-semibold">Temp. Max</th>
                        <th className="px-6 py-5 text-center font-semibold">Temp. Min</th>
                        <th className="px-6 py-5 text-center font-semibold">Umidità</th>
                        <th className="px-6 py-5 text-center font-semibold">Vento</th>
                        <th className="px-6 py-5 text-center font-semibold">Condizioni</th>
                    </tr>
                </thead>
                <tbody>
                     ...
                     // Filtra le previsioni per mostrare solo una previsione ogni 24 ore tranne la giornata attuale
                        ...
                        .map((forecast, index) => (
                            <tr key={index} className="border-b last:border-none hover:bg-blue-50 transition-colors">
                                <td className="px-6 py-5 text-gray-700 font-medium text-center">
                                    {new Date(forecast.dt * 1000).toLocaleDateString("it-IT", { weekday: 'long' })}
                                </td>
                                <td className="px-6 py-5 text-blue-600 font-bold text-center">{forecast.main.temp}°C</td>
                                <td className="px-6 py-5 text-gray-600 text-center">{forecast.main.temp_max}°C</td>
                                <td className="px-6 py-5 text-gray-600 text-center">{forecast.main.temp_min}°C</td>
                                <td className="px-6 py-5 text-gray-600 text-center">{forecast.main.humidity}%</td>
                                <td className="px-6 py-5 text-gray-600 text-center">{forecast.wind.speed} m/s</td>
                                <td className="px-6 py-5 flex items-center justify-center text-gray-600 font-semibold">
                                    <img
